...
function AuditTrail() {
  ...
  return (
    <AppShell
      role="patient"
      title="Audit Trail"
      subtitle="Full patient-visible history of uploads, doctor access, emergency permissions, downloads, and blockchain-linked healthcare interactions."
    >
          ...
          <div className="relative space-y-4">
            ...
            {filteredLogs.map((log, index) => (
              <motion.div
                ...
                className={`relative rounded-3xl border p-5 backdrop-blur-xl ${getActionClass(
                  log.action
                )}`}
              >
